...
public class Menu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ("smoothie".equals(menuType)) {
            ...
            menu menu1 = new menu();
            menu1.setMenu_name("Fried buns with minced pork egg");
            ...
            menu menu2 = new menu();
            menu2.setMenu_name("Spaghetti With Spicy");
            ...
            menu menu3 = new menu();
            menu3.setMenu_name("Homemade ice cream");
